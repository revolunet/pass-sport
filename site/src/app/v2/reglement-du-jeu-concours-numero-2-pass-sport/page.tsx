  ...
  return (
    <>
      <main tabIndex={-1} id={SKIP_LINKS_ID.mainContent} role="main">
        ...
        <div className={cn(styles.main, styles.wrapper)}>
          <section className="fr-mb-6w">
            ...
            <p>
              La présente opération vise à promouvoir le pass Sport et la pratique sportive en
              France en la rendant plus accessible par le biais de Créateurs de Contenus.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p>
              Le présent jeu-concours est ouvert à toute personne physique, majeure résidant en
              France à l&apos;exclusion des membres du personnel de l&apos;Organisateur, et
              d&apos;une façon générale des sociétés participant à la mise en œuvre de ce
              jeu-concours.
            </p>
            <p>
              L&apos;Organisateur se réserve le droit de demander la justification écrite de
              l&apos;âge du Participant à tout moment, a fortiori lors de l&apos;attribution des
              lots.
            </p>
            <p>
              L&apos;Organisateur serait contraint de disqualifier toute personne qui serait dans
              l&apos;incapacité de fournir ce justificatif dans les délais qui lui seraient
              impartis. Dans ce cas, tout gain potentiellement obtenu durant le jeu-concours serait
          ...
          <section className="fr-mb-6w">
            ...
            <p>
              ...
              du concours conformément à l&apos;article 3 du présent règlement.
            </p>

            <p className={styles.underline}>
              Le Concours sera accessible via le compte de l&apos;un des Créateur de Contenus
              suivants :
            </p>
            ...
            <p>
              Le Participant devra s&apos;abonner au compte Instagram @passsportofficiel, commenter
              la publication du créateur suivi en lien avec le présent concours et identifier (@) un
              ami avec qui ce dernier souhaiterait pratiquer un sport.
            </p>
            ...
            <p>
              ...
              identifiant (@) le compte Instagram @passsportofficiel ainsi que le @ du compte
              créateur par le biais duquel il aura participé.
            </p>

            <p>
              La participation est limitée à un post par Participant. Toute participation multiple
              de la part d&apos;un Participant sera considérée comme une seule et unique
              participation.
            </p>
            ...
            <p>
              ...
              cette opération en cas de violation des présentes, par fraude ou par tout autre cause
              hors de son contrôle.
            </p>
            <p>
              De façon générale, les Participants garantissent l&apos;Organisateur du présent
              concours contre tous recours, actions ou réclamations que pourraient former, à un
              titre quelconque, tous tiers, au titre de toutes les garanties et engagements pris.
            </p>
            <p>
            ...
            <p>
              Ainsi, l&apos;Organisateur se réserve le droit, sans réserve, de modérer à postériori
              et de ne pas valider, d&apos;exclure, ou de supprimer du concours, tout participant
              qui ne respecterait pas une des conditions du présent règlement.
            </p>
            ...
            <p>
              ...
              l&apos;enseigne DECATHLON (d&apos;un montant de 300€ TTC) ainsi qu&apos;un abonnement
              ou une licence d&apos;une année dans un club ou une salle de sport du choix du Gagnant
            ...
            <p>
              ...
              modalités d&apos;utilisation des lots dans les 15 jours suivants la fin du
              jeu-concours.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p>
              ...
              d&apos;une valeur de 300 euros TTC ainsi qu&apos;un abonnement ou une licence
              d&apos;un an dans un club de sport ou une salle de sport, d&apos;une valeur maximale
              de 500 euros TTC.
            </p>
            <p>
            ...
            <p>
              ...
              était le cas, la valeur du lot serait équivalente ou supérieure aux produits
              remplacés. La contrepartie en chèque, en numéraire ou en chèque cadeau ne peut être
              proposée.
            </p>
            ...
            <p>
              Si les informations communiquées par le Gagnant sont incomplètes et/ou ne permettent
              pas de l&apos;informer de son gain, il perdra la qualité de Gagnant et ne pourra
              effectuer aucune réclamation.
            </p>
            <p>
            ...
            <p>
              La notification officielle et personnalisée d&apos;attribution des dotations au
              Gagnant avec le descriptif et les modalités de retrait lui seront communiquées par
              email suite à un premier échange via la Plateforme Instagram.
            </p>
          </section>

          <section className="fr-mb-6w">
            <h2 className="fr-mb-2w">Article 6 - Données nominatives et personnelles</h2>
            ...
            <p>
              Dans le cadre de leur traitement, les données des Participants pourront être
              transmises à des sous-traitants situes hors de l&apos;Union Européenne conformément
              aux réglementations et aux recommandations de la Commission Européenne et ce, sous la
              responsabilité de l&apos;Organisateur, responsable de traitement.
            </p>
            <p>
              Les données seront conservées pendant toute la durée du présent jeu-concours et dans
              un délai maximum de six (6) mois à l&apos;issue de la remise de la dotation aux
              Gagnants.
            </p>
            <p>
              ...
              suppression des données qui les concernent, ainsi que du droit de définir des
              directives relatives au sort de leurs données à caractère personnel dans le cas où les
              Participants ne pourraient plus exercer les droits précités en s&apos;adressant par
              courrier à l&apos;Organisateur dont l&apos;adresse est mentionnée à l&apos;article 1.
            </p>
          </section>

          <section className="fr-mb-6w">
            <h2 className="fr-mb-2w">Article 7 - Responsabilités et droits</h2>
          ...
          <section className="fr-mb-6w">
            <h2 className="fr-mb-2w">Article 8 - Conditions d&apos;exclusion</h2>
            <p>
          ...
          <section className="fr-mb-6w">
            <h2 className="fr-mb-2w">Article 9 – Règlement du jeu</h2>
          ...
          <section className="fr-mb-6w">
            <h2 className="fr-mb-2w">Article 10 - Juridictions compétentes</h2>
            ...
            <p>
              L&apos;Organisateur se réserve le droit de trancher sans appel toute difficulté
              pouvant survenir quant à l&apos;interprétation ou à l&apos;application du présent
              règlement, étant entendu qu&apos;aucune contestation ne sera admise notamment portant
              sur les modalités du jeu, sur la détermination du Gagnant, sur les conditions
              d&apos;octroi ou d&apos;utilisation des gains, un mois après la fin du jeu.
            </p>
