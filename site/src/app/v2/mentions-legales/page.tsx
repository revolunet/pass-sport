...
export default function PolitiqueDeConfidentialite() {
  return (
    <div>
      <PageHeader
        title="Mentions légales de « pass Sport »"
        subtitle=""
        classes={{
      ...
      <main className={styles.wrapper} tabIndex={-1} id={SKIP_LINKS_ID.mainContent} role="main">
        ...
        <section className="fr-mb-4w">
          ...
          <p className="fr-mb-2w">
            ...
            n&apos;obtenez pas de réponse rapide de notre part, vous êtes en droit de faire parvenir
        ...
        <section>
          ...
          <p>
            ...
            échanges. En aucun cas les services associés à la plateforme ne seront à l&apos;origine
