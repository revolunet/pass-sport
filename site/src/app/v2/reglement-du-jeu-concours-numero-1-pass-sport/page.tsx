        ...
        <div className={styles.wrapper}>
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              présent règlement définit les règles juridiques applicables au jeu-concours «
              Ministère des Sports et des Jeux Olympiques et Paralympiques x pass Sport».
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              l&apos;Organisateur, et d&apos;une façon générale des sociétés participant à la mise
              en œuvre de ce jeu-concours. Il est toutefois impératif qu&apos;un mineur qui souhaite
              ...
              tout moment, a fortiori lors de l&apos;attribution des lots. L&apos;Organisateur
              serait contraint de disqualifier tout mineur qui serait dans l&apos;incapacité de
              fournir ce justificatif dans les délais qui lui seraient impartis. Dans ce cas, tout
              gain potentiellement obtenu durant le jeu-concours serait immédiatement annulé.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              plateforme Instagram (www.instagram.com), à compter des dates indiquées pour le début
              du concours conformément à l&apos;article 3 du présent règlement. Le Concours sera
            ...
            <p className="fr-mb-2w">
              Le Participant devra répondre à une question posée en story par l&apos;un des
              Créateurs officiels mentionnés ci-dessus.
            </p>
            ...
            <p className="fr-mb-2w">
              Cette story restera accessible via les outils d&apos;épinglage prévus par le
              plateforme Instagram Instagram sur le profil de chaque Créateur pour une durée de 5
              jours à compter de la publication de la Story.
            </p>
            <p className="fr-mb-2w">
            ...
            <p className="fr-mb-2w">
              ...
              listés ci- dessus, cependant il ne pourra pas cumuler les lots et sera limité à un
              seul gain en cas de tirage au sort.
            </p>
            ...
            <p className="fr-mb-2w">
              L&apos;Organisateur se réserve le droit d&apos;annuler, de mettre fin ou modifier
              cette opération en cas de violation des présentes, par fraude ou par toute autre cause
              hors de son contrôle. De façon générale, les Participants garantissent
              l&apos;Organisateur du présent concours contre tous recours, actions ou réclamations
              que pourraient former, à un titre quelconque, tous tiers, au titre de toutes les
              garanties et engagements pris. Toute participation incomplète ou erronée sera rejetée
              sans que la responsabilité de l&apos;Organisateur ne puisse être engagée. Ainsi,
              l&apos;Organisateur se réserve le droit, sans réserve, de modérer à postériori et de
              ne pas valider, d&apos;exclure, ou de supprimer du concours, tout participant qui ne
            ...
            <p className="fr-mb-2w">
              ...
              réponse, l&apos;originalité de la réponse, la créativité de la réponse et ce pour
              chaque Créateur. Les Gagnants seront directement contactés par le Créateur par message
              privé sur le compte Instagram avec lequel ils auront participé au jeu-concours afin de
              prévoir les modalités d&apos;utilisation des lots dans les 15 jours suivants la fin du
              jeu-concours. Chaque Créateur permettra la sélection d&apos;un minimum 5 Gagnants
              parmi les personnes ayant répondu au post.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              jeu-concours soit une valeur de 30 euros TTC. Le lot offert ne peut donner lieu à
              aucune contestation sur sa nature ni à la remise d&apos;une contrepartie de quelque
              nature que ce soit. Le lot ne couvre pas les frais de déplacement du Gagnant pour se
              rendre à la séance de sport. L&apos;Organisateur se réserve le droit de changer la
              dotation sans préavis. Si tel était le cas, la valeur du lot serait équivalente ou
              supérieure aux produits remplacés. La contrepartie en chèque, en numéraire ou en
              chèque cadeau ne peut être proposée.
            </p>
            ...
            <p className="fr-mb-2w">
              ...
              message privé par le biais du compte Instagram avec lequel le Participant aura
              participé au jeu-concours et ce, dans un délai de 15 jours à compter du la fin du
              jeu-concours. Si les informations communiquées par le Gagnant sont incomplètes et/ou
              ne permettent pas de l&apos;informer de son gain, il perdra la qualité de Gagnant et
              ne pourra effectuer aucune réclamation. L&apos;Organisateur ne pourra par ailleurs
              être tenu responsable dans le cas de défaillances techniques quant à cette
              notification de gain. La notification officielle et personnalisée d&apos;attribution
              des dotations au Gagnant avec le descriptif et les modalités de retrait lui seront
              communiquées par email suite à un premier échange via la Plateforme Instagram.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              prétendre à aucune compensation financière. Chaque Gagnant autorise
              l&apos;Organisateur à exploiter son image, sa voix ou son témoignage dans le cadre de
              toute déclaration recueillie et ce sur tous supports (photographie, internet,
              verbatim, « flyers » et/ou vidéo) existants ou à venir, à des fins de relations
              publiques en France, sans que cette utilisation ne lui confère une rémunération ou une
              contrepartie autre que le soutien apporté. Tout Gagnant accepte que son image et les
              attributs de sa personnalité soient reproduits et utilisé par l&apos;Organisateur dans
              le cadre de contenu vidéo produit en partenariat avec les Créateurs. Les Gagnants
              acceptent de ce fait d&apos;être filmés dans le cadre des communications prévues.
              L&apos;ensemble des droits susvisés sont cédés pour le monde entier et pour une durée
              de douze (12) mois, soit un (1) an.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              traitement. Les données seront conservées pendant toute la durée du présent
              jeu-concours et dans un délai maximum de six (6) mois à l&apos;issue de la remise de
              la dotation aux Gagnants. Les Participants disposent d&apos;un droit d&apos;accès,
              d&apos;opposition, de modification, de rectification, d&apos;effacement, de
              limitation, de portabilité et de suppression des données qui les concernent, ainsi que
              du droit de définir des directives relatives au sort de leurs données à caractère
              personnel dans le cas où les Participants ne pourraient plus exercer les droits
              précités en s&apos;adressant par courrier à l&apos;Organisateur dont l&apos;adresse
              est mentionnée à l&apos;article 1.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <ul className="fr-mb-2w">
              <li>
                a) Se réserve le droit de modifier, de proroger, d&apos;écourter, de limiter les
                gains ou d&apos;annuler ce jeu-concours en cas de force majeure. En conséquence, sa
                responsabilité ne saurait être engagée de ce fait.
              </li>
              <li>
                b) Dégage toute responsabilité en cas de problèmes d&apos;acheminement ou de perte
                de courrier électronique ou postal empêchant le bon déroulement du jeu-concours.
              </li>
            </ul>

            <p className="fr-mb-2w">
              L&apos;assurance lors de la pratique sportive sera assurée par les clubs ou salles de
              sport directement. Un éducateur diplômé d&apos;état sera présent lors de la scéance
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              modalités énoncées dans le présent règlement sans aucune réserve ni condition
              préalable des Participants, le non-respect dudit règlement, entraînant
              l&apos;exclusion du concours, la nullité pure et simple de la participation et de
              l&apos;attribution du lot. Ainsi, tout Participant s&apos;engage à être abonné aux
              comptes Instagram du Créateur par le biais duquel il aurait participé ainsi qu&apos;au
              compte Instagram pass&apos;Sport. En outre, tout Participant s&apos;engage à respecter
              les limites d&apos;âge fixées par profil de Créateur par le biais duquel il aurait
              participé.
            </p>
          </section>
          ...
          <section className="fr-mb-6w">
            ...
            <p className="fr-mb-2w">
              ...
              trancher sans appel toute difficulté pouvant survenir quant à l&apos;interprétation ou
              à l&apos;application du présent règlement, étant entendu qu&apos;aucune contestation
              ne sera admise notamment portant sur les modalités du jeu, sur la détermination du
              Gagnant, sur les conditions d&apos;octroi ou d&apos;utilisation des gains, un mois
              après la fin du jeu. Si le désaccord persiste, il sera soumis au Tribunal Judiciaire
              de Paris. Le Participant reconnaît avoir pris connaissance du présent règlement,
              l&apos;accepter sans réserve et s&apos;y conformer.
            </p>
          </section>
        </div>
      </main>
