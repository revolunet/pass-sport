export default function TranscriptionVisibilityClub() {
  return (
    <ul>
      <li>
        <p>
          Un créateur de contenu se tient face caméra depuis un studio décoré avec des éléments
          rappelant l&apos;univers du sport (trophées, ballons etc..).
        </p>
        <p>
          <span className="fr-text--bold fr-mb-1w display--block">Le créateur</span>
        ...
        <p>
          {'{transition}'} Après l&apos;introduction, l&apos;écran se divise en deux pour faire
          apparaître un écran d&apos;ordinateur tout en montrant le créateur face caméra.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          précisez quel type de handicap. N&apos;oubliez pas d&apos;enregistrer !
        </p>
      </li>
      <li>
        <p>
          ...
          clubs agréés, saisissez comme affiliation “agrément sport” ou “agrément JEP”. Pour les
          structures marchandes, saisissez “Loisir sportif marchand” ou “LSM” dans le menu
          déroulant.
        </p>
      </li>
      <li>
      ...
      <li>
        <p>
          ...
          affiliée à une fédération sportive agréée, déposez la charte d&apos;engagement des loisirs
          sportifs marchands au dispositif. Cette charte est transmise par les têtes de réseaux
          (USC, COSMOS, ACTIVE-FNEAL) si vous êtes adhérents mais elle est également disponible sur
          le site pass.sports.gouv.fr si vous n&apos;êtes pas adhérent.
        </p>
      </li>
      <li>
        <p>
          ...
          informations correspondent bien avec l&apos;adhérent. N&apos;oubliez pas de valider ! La
          demande sera transmise automatiquement dans les minutes suivantes, vous verrez son état
          évoluer jusqu&apos;à une phase « payé » qui correspondra au remboursement de ce pass !
        </p>
      </li>
      <li>
        <p>
