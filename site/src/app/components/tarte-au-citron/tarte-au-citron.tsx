...
export const TarteAuCitron = () => {
  ...
  return (
    <Script
      id="test"
      src="https://tarteaucitron.io/load.js?domain=localhost&uuid=19b13211bfb1bd1efd6f804a26674ed864265114"
      onLoad={() => {
        // @ts-ignore
        let sdk = tarteaucitron;
        ...
        console.log('it has been loaded', tarteaucitron);
      }}
    />
  );
};
